...
A monografia está organizada da seguinte maneira: no Capítulo~\ref{cap:objetivos} serão apresentados o objetivo geral e os objetivos específicos e no Capítulo~\ref{cap:metodologia} serão apresentadas informações sobre a metodologia, destacando as ferramentas que serão utilizadas na análise.
