...
% TODO
% Uma técnica bastante popular é o agrupamento dos \textit{tokens} para ser posteriormente realizada uma representação visual dos dados, onde o tamanho do \textit{token} representa sua frequência em um dado corpus, e sua coloração pode servir para representar o sentimento do \textit{token}. Essa representação gráfica é nomeada \textit{wordcloud}, ou nuvem de palavras.
