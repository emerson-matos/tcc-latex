...
A primera etapa consiste em identificar os hotéis distribuidos no território brasileiro agrupados por estado, por meio do serviço exposto do Google Maps, a iteração foi realizada utilizando a biblioteca escrita em java, \citeonline{javaGoogleMapsService2022} que está disponível publicamente no repositório no \citeonline{github2023}.
