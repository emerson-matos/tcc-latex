...
\subsection{BERT e Transformers}
...
Todos executados utilizando a biblioteca transformers \cite{Wolf_Transformers_State-of-the-Art_Natural_2020}, utilizando o AutoTokenizer, AutoModelForSequenceClassification e pipeline, executados usando device Cuda (Nvidia RTX 4070TI com 12gb de VRAM) %% mais detalhes do ambiente de execução?
...
Nessa etapa cada um dos modelos Berts atribuia a avaliação um score indicando a confiança de uma dada etiqueta ser a classificação correta daquele review. Após todas as analises terminarem foi realizado então a união dos resultados e a etiqueta escolhida será igual a do modelo bert que atribuir o \emph{score} mais alto.
...
%TODO
Os resultados da análise de sentimentos foram avaliados em termos de sua precisão e sua capacidade de capturar com precisão o sentimento dos usuários nas avaliações de hotéis. Os diferentes modelos utilizados foram comparados.
